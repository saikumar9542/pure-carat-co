 ...
 * Add/remove entries here; pages render automatically.
 * ------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * PRODUCTS — sample entries. Add unlimited items to any category;
 * the gallery paginates automatically.
 * ------------------------------------------------------------------------- */
const PRODUCTS = [
  // Rings
  { id: 1,  category: 'rings',      name: 'Aurora Solitaire',   description: '18k gold solitaire with a brilliant round cut.',       price: 42500, image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=600&q=80' },
  { id: 2,  category: 'rings',      name: 'Eternity Band',      description: 'Full-circle diamond band in yellow gold.',              price: 68900, image: 'https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?auto=format&fit=crop&w=600&q=80' },
  { id: 3,  category: 'rings',      name: 'Vintage Halo',       description: 'Rose-cut center stone with milgrain halo.',             price: 55200, image: 'https://images.unsplash.com/photo-1600721391689-2564bb8055de?auto=format&fit=crop&w=600&q=80' },

  // Necklaces
  { id: 10, category: 'necklaces',  name: 'Layla Chain',        description: 'Delicate 22k gold chain, 18-inch length.',              price: 32400, image: 'https://images.unsplash.com/photo-1599643477877-530eb83abc8e?auto=format&fit=crop&w=600&q=80' },
  { id: 11, category: 'necklaces',  name: 'Meera Pendant Set',  description: 'Temple-inspired pendant with matching studs.',          price: 78900, image: 'https://images.unsplash.com/photo-1611652022419-a9419f74343d?auto=format&fit=crop&w=600&q=80' },

  // Earrings (studs as sample)
  { id: 20, category: 'studs',      name: 'Solitaire Studs',    description: 'Classic prong-set studs in white gold.',                price: 28900, image: 'https://images.unsplash.com/photo-1535632066274-36f0f39b1e29?auto=format&fit=crop&w=600&q=80' },
  { id: 21, category: 'jhumkas',    name: 'Rajwada Jhumkas',    description: 'Handcrafted temple jhumkas with pearl drops.',          price: 46700, image: 'https://images.unsplash.com/photo-1631160299919-6a56d21a4b7a?auto=format&fit=crop&w=600&q=80' },

  // Bracelets
  { id: 30, category: 'bracelets',  name: 'Aria Cuff',          description: 'Sculpted gold cuff with brushed finish.',               price: 51200, image: 'https://images.unsplash.com/photo-1611085583191-a3b181a88401?auto=format&fit=crop&w=600&q=80' },
  { id: 31, category: 'tennis-bracelets', name: 'Aurelia Tennis', description: 'Bezel-set diamonds on a delicate chain.',             price: 124500, image: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?auto=format&fit=crop&w=600&q=80' },

  // Bangles
  { id: 40, category: 'bangles',    name: 'Kanchi Bangles',     description: 'Set of two textured 22k bangles.',                      price: 88500, image: 'https://images.unsplash.com/photo-1620656798932-902a5b02b3bc?auto=format&fit=crop&w=600&q=80' },

  // Anklets
  { id: 50, category: 'anklets',    name: 'Payal Delight',      description: 'Silver ghungroo anklet with gold plating.',             price: 12400, image: 'https://images.unsplash.com/photo-1584967335069-b5c5b03bb6de?auto=format&fit=crop&w=600&q=80' },

  // Chains
  { id: 60, category: 'chains',     name: 'Rope Chain 20"',     description: 'Solid yellow gold rope chain.',                         price: 41200, image: 'https://images.unsplash.com/photo-1611652022419-a9419f74343d?auto=format&fit=crop&w=600&q=80' },
];
